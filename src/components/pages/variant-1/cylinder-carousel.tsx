...
export function CylinderCarousel() {
    ...
    images.forEach((imageSrc, index) => {
      ...
      img.onload = () => {
        ...
        if (loadedImages === numImages) {
          ...
          // Animate About Us button with last section
          const aboutBtn = document.getElementById('about-us-btn');
          if (aboutBtn) {
            const lastIndex = perspectives.length - 1;
            const sectionDuration = 100 / perspectives.length;
            const start = lastIndex * sectionDuration;
            const end = (lastIndex + 1) * sectionDuration;
            ...
            gsap.timeline({
              ...
              .fromTo(aboutBtn, { opacity: 0 }, { opacity: 1, duration: 0.2, ease: 'cinematicSmooth' })
              .to(aboutBtn, { opacity: 1, duration: 0.6, ease: 'none' })
              .to(aboutBtn, { opacity: 0, duration: 0.2, ease: 'cinematicSmooth' });
          }
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 pointer-events-none z-30 text-white">
